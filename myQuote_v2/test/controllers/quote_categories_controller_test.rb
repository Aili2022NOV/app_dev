...
class QuoteCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quote_category" do
    assert_difference("QuoteCategory.count") do
      post quote_categories_url, params: { quote_category: { catergories_id: @quote_category.catergories_id, quotes_id: @quote_category.quotes_id } }
    end
  ...
  test "should update quote_category" do
    patch quote_category_url(@quote_category), params: { quote_category: { catergories_id: @quote_category.catergories_id, quotes_id: @quote_category.quotes_id } }
